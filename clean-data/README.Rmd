...
QQ: fix "funs" error that results from following chunk of code by using tilda
...
QQ: address warning message that results from next chunk: 
"Factor `IS3G04A` contains implicit NA, consider using `forcats::fct_explicit_na`" 
...
QQ: check missings are being recoded appropriately for dat output as "."
```{r}
