...
View how NA represented
QQ: how possible to view more than 1st 5 lines of dataframe?

```{r, include=FALSE}
head(tbl_allcountries_2016_2step) %>% View
```
